...
public class LexerOld {
  ...
  private static final String ZZ_CMAP_PACKED = 
    "\11\6\1\3\1\2\1\55\1\56\1\1\16\6\4\0\1\3\1\44"+
    "\2\0\1\5\1\42\1\37\1\54\1\47\1\50\1\43\1\46\1\0"+
    "\1\41\1\12\1\4\1\10\11\7\1\0\1\53\1\0\1\36\1\40"+
    "\2\0\13\5\1\11\16\5\4\0\1\5\1\0\1\27\1\33\1\25"+
    "\1\24\1\14\1\32\1\35\1\34\1\23\2\5\1\26\1\5\1\13"+
    "\1\22\2\5\1\16\1\30\1\17\1\20\1\21\1\15\1\31\2\5"+
    "\1\51\1\45\1\52\1\0\6\6\1\57\32\6\2\0\4\5\4\0"+
    ...
    "\3\5\1\0\7\5\16\0\5\6\30\0\1\55\1\55\5\6\20\0"+
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    ...
    "\1\16\1\6\1\17\1\20\1\21\1\22\3\6\1\23"+
    "\1\24\2\6\1\25\1\26\1\27\1\30\1\31\1\32"+
    "\1\33\1\34\1\35\1\36\1\37\1\40\1\41\1\42"+
    "\1\43\1\2\1\4\1\2\62\0\1\4\61\0\1\44"+
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            ...
            System.out.println("action [138] { throw new UnexpectedCharacterException(yytext(), yyline, yycolumn); }");
          ...
          case 3: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [67] { return new OpDiv(yyline, yycolumn); }");
            { return new OpDiv(yyline, yycolumn);
            }
          case 43: break;
          case 4: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [135] { return new Identifier(yyline, yycolumn, yytext()); }");
            { return new Identifier(yyline, yycolumn, yytext());
            }
          case 44: break;
          case 5: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [99] { Integer num;"+ZZ_NL+"\t\t\t\t\t"+ZZ_NL+"\t\t\t\t\t// throws NumberFormatException"+ZZ_NL+"\t\t\t\t\tnum = Integer.parseInt(yytext());"+ZZ_NL+""+ZZ_NL+"\t\t\t\t\treturn new LitInt(yyline, yycolumn, num); }");
            { Integer num;
          ...
          case 6: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [87] { return new Period(yyline, yycolumn); }");
            { return new Period(yyline, yycolumn);
            }
          case 46: break;
          case 7: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [65] { return new Assignment(yyline, yycolumn); }");
            { return new Assignment(yyline, yycolumn);
            }
          case 47: break;
          case 8: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [69] { return new OpGT(yyline, yycolumn); }");
            { return new OpGT(yyline, yycolumn);
            }
          case 48: break;
          case 9: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [71] { return new OpMinus(yyline, yycolumn); }");
            { return new OpMinus(yyline, yycolumn);
            }
          case 49: break;
          case 10: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [72] { return new OpMod(yyline, yycolumn); }");
            { return new OpMod(yyline, yycolumn);
            }
          case 50: break;
          case 11: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [73] { return new OpMult(yyline, yycolumn); }");
            { return new OpMult(yyline, yycolumn);
            }
          case 51: break;
          case 12: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [74] { return new OpNot(yyline, yycolumn); }");
            { return new OpNot(yyline, yycolumn);
            }
          case 52: break;
          case 13: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [76] { return new OpPlus(yyline, yycolumn); }");
            { return new OpPlus(yyline, yycolumn);
            }
          case 53: break;
          case 14: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [80] { return new BracketL(yyline, yycolumn); }");
            { return new BracketL(yyline, yycolumn);
            }
          case 54: break;
          case 15: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [81] { return new BracketR(yyline, yycolumn); }");
            { return new BracketR(yyline, yycolumn);
            }
          case 55: break;
          case 16: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [82] { return new CurlyBraceL(yyline, yycolumn); }");
            { return new CurlyBraceL(yyline, yycolumn);
            }
          case 56: break;
          case 17: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [83] { return new CurlyBraceR(yyline, yycolumn); }");
            { return new CurlyBraceR(yyline, yycolumn);
            }
          case 57: break;
          case 18: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [88] { return new Semicolon(yyline, yycolumn); }");
            { return new Semicolon(yyline, yycolumn);
            }
          case 58: break;
          case 19: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [107] { Long num;"+ZZ_NL+""+ZZ_NL+"\t\t\t\t\t// Guaranteed to end in L or l"+ZZ_NL+"\t\t\t\t\tString numText = yytext().substring(0, yytext().length()-1);"+ZZ_NL+""+ZZ_NL+"\t\t\t\t\t// throws NumberFormatException"+ZZ_NL+"\t\t\t\t\tnum = Long.parseLong(numText);"+ZZ_NL+""+ZZ_NL+"\t\t\t\t\treturn new LitLong(yyline, yycolumn, num); }");
            { Long num;
          ...
          case 20: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [124] { double num;"+ZZ_NL+""+ZZ_NL+"\t\t\t\t\t// throws NumberFormatException"+ZZ_NL+"\t\t\t\t\tnum = Double.parseDouble(yytext());"+ZZ_NL+""+ZZ_NL+"\t\t\t\t\treturn new LitDouble(yyline, yycolumn, num); }");
            { double num;
          ...
          case 21: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [50] { return new KeywordIf(yyline, yycolumn); }");
            { return new KeywordIf(yyline, yycolumn);
            }
          case 61: break;
          case 22: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [68] { return new OpEq(yyline, yycolumn); }");
            { return new OpEq(yyline, yycolumn);
            }
          case 62: break;
          case 23: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [66] { return new OpAnd(yyline, yycolumn); }");
            { return new OpAnd(yyline, yycolumn);
            }
          case 63: break;
          case 24: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [70] { return new OpGTE(yyline, yycolumn); }");
            { return new OpGTE(yyline, yycolumn);
            }
          case 64: break;
          case 25: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [75] { return new OpOr(yyline, yycolumn); }");
            { return new OpOr(yyline, yycolumn);
            }
          case 65: break;
          case 26: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [45] { return new KeywordNew(yyline, yycolumn); }");
            { return new KeywordNew(yyline, yycolumn);
            }
          case 66: break;
          case 27: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [60] { return new TypeInt(yyline, yycolumn); }");
            { return new TypeInt(yyline, yycolumn);
            }
          case 67: break;
          case 28: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [118] { // character guaranteed to be 2nd char, of 3"+ZZ_NL+"\t\t\t\t\tCharacter c = yytext().charAt(1);"+ZZ_NL+""+ZZ_NL+"\t\t\t\t\treturn new LitChar(yyline, yycolumn, c); }");
          ...
          case 29: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [52] { return new KeywordNull(yyline, yycolumn); }");
            { return new KeywordNull(yyline, yycolumn);
            }
          case 69: break;
          case 30: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [51] { return new KeywordElse(yyline, yycolumn); }");
            { return new KeywordElse(yyline, yycolumn);
            }
          case 70: break;
          case 31: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [97] { return new LitBool(yyline, yycolumn, true); }");
            { return new LitBool(yyline, yycolumn, true);
            }
          case 71: break;
          case 32: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [47] { return new KeywordVoid(yyline, yycolumn); }");
            { return new KeywordVoid(yyline, yycolumn);
            }
          case 72: break;
          case 33: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [58] { return new TypeChar(yyline, yycolumn); }");
            { return new TypeChar(yyline, yycolumn);
            }
          case 73: break;
          case 34: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [61] { return new TypeLong(yyline, yycolumn); }");
            { return new TypeLong(yyline, yycolumn);
            }
          case 74: break;
          case 35: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [48] { return new KeywordClass(yyline, yycolumn); }");
            { return new KeywordClass(yyline, yycolumn);
            }
          case 75: break;
          case 36: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [98] { return new LitBool(yyline, yycolumn, false); }");
            { return new LitBool(yyline, yycolumn, false);
            }
          case 76: break;
          case 37: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [46] { return new KeywordReturn(yyline, yycolumn); }");
            { return new KeywordReturn(yyline, yycolumn);
            }
          case 77: break;
          case 38: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [59] { return new TypeDouble(yyline, yycolumn); }");
            { return new TypeDouble(yyline, yycolumn);
            }
          case 78: break;
          case 39: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [49] { return new KeywordExtends(yyline, yycolumn); }");
            { return new KeywordExtends(yyline, yycolumn);
            }
          case 79: break;
          case 40: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [57] { return new TypeBoolean(yyline, yycolumn); }");
